...
namespace core {
    ...
    public:
        ...
        virtual void PostDelayedTask(std::unique_ptr<QueuedTask> task, std::chrono::milliseconds delay) = 0;

        virtual void PostDelayedHighPrecisionTask(std::unique_ptr<QueuedTask> task, std::chrono::milliseconds delay) = 0;
